...
function music_star_customize_register_content( $wp_customize ) {
/**
 * Recent Posts
 */
		$wp_customize->add_section( 'seos_content_section' , array(
			'title'       => __( 'Content Options', 'music-star' ),
			'priority'    => 2,	
		 ...
		 $wp_customize->add_control( 'content_max_width', array(
		  ...
		  'label' => __( 'Content max width', 'music-star' ),
		  'input_attrs' => array(
			'min' => 1210,
			'max' => 2000,
			'step' => 1,
		 ...
		 $wp_customize->add_control( 'content_padding', array(
		  ...
		  'label' => __( 'Content Padding', 'music-star' ),
		  'input_attrs' => array(
			'min' => 0,
			'max' => 100,
			'step' => 1,
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'hide_home_content', array(
			'label'    => __( 'Hide sidebar and content on home page', 'music-star' ),
			'section'  => 'seos_content_section',
			'priority'    => 1,				
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'hide_featured', array(
			'label'    => __( 'Show featured images on all single pages.', 'music-star' ),
			'section'  => 'seos_content_section',
			'priority'    => 1,				
...
add_action( 'customize_register', 'music_star_customize_register_content' );
/********************************************
* Content Styles
*********************************************/ 	
function music_star_content_styles () {
...
add_action( 'wp_enqueue_scripts', 'music_star_content_styles' );